...
{
	public static var STRUM_X = 62;
	public static var STRUM_X_MIDDLESCROLL = -268;
	...
	override public function create()
	{
		...
		timeBar = new FlxSprite(0, 25);
		timeBar.loadGraphic(Paths.image('hud/clock'));
	...
	override public function update(elapsed:Float)
	{
		...
		if(isLiftMechanicEnabled && !watchingMechanicInfo && !startedCountdown)
		{
			if(curSong == 'Dad Battle')
			{
